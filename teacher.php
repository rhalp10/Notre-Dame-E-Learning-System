          ...
          <div class="col-lg-12">
            <section class="panel" style="border-radius: 5px;box-shadow: 0 15px 25px rgba(0,0,0,.9)">
              <div class="container">
                ...
                <span class="pull-left"><a href="#teacher" data-toggle="modal" class="btn btn-info"><span class="fa fa-plus"></span> Add Teacher</a></span>
                <div style="height:50px;"></div>
                  <div class="panel panel-warning">
                    <header class="panel-heading">
                      <div class="fa fa-group"></div> Teachers Information
                    </header>
                      ...
                      <?php
                        ...
                        while($row=mysqli_fetch_array($query)){
                          ...
                          <tr>
                            ...
                            <td><div class="fa fa-folder-open"></div> <?php echo $row['section']; ?><br>
                            	<div class="fa fa-folder-open"></div> <?php echo $row['section2']; ?><br>
                            	<div class="fa fa-folder-open"></div> <?php echo $row['section3']; ?><br>
                            	<div class="fa fa-folder-open"></div> <?php echo $row['section4']; ?><br>
                            	<div class="fa fa-folder-open"></div> <?php echo $row['section5']; ?>
                            </td>
                            <td>
