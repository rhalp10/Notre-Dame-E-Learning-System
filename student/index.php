...
<head>
  ...
  <link href="css/style-responsive.css" rel="stylesheet" />
    ...
    <body style="background-image: url('image/h.jpg');background-size: cover">
      ...
      <span class="profile-ava">
        ...
        <div class="login-box">
          <div class="login-box-body" style="position: absolute; top:53%;left:50%; transform: translate(-50%,-50%);width: 450px; padding: 40px; background: rgba(0,0,0,.6);box-shadow: 0 15px 25px rgba(0,0,0,.9); border-radius: 10px ">
            <p class="login-box-msg" style="color: white; font-size: 20px; font-family: cooper black"><b>Student Login</b></p>
