              ...
              <div class="container">
                ...
                <div class="panel panel-warning">
                  <header class="panel-heading">
                    <div class="fa fa-folder-open"></div> File Uploaded
                  </header>
                    ...
                    <tbody>
                        <tr>
                          ...
                          <td>
                           ...
                           <td>
                              <a href="#update<?php echo $row['teacher_id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="icon_trash_alt"></span> Delete</a>
