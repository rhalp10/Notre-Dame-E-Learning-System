...
foreach($result as $row)
{
	...
	$sub_array[] = '<div class="dropdown"><button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Action<span class="caret"></span></button><ul class="dropdown-menu"><li><a href="#" id="'.$row["ledger_ID"].'" class="view">View Trial Balance</a><a href="#" id="'.$row["ledger_ID"].'" class="entry">Add Entry</a></li><li><a href="#" id="'.$row["ledger_ID"].'" class="update">Update</a></li><li><a href="#" id="'.$row["ledger_ID"].'" class="delete">Delete</a></li></ul></div>';
