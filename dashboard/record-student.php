<div class="container">
  ...
  <span class="pull-left"><button type="button" class="btn btn-success add" data-toggle="modal" data-target="#student_modal"><span class="fa fa-plus"></span> ADD STUDENT</button></span>
  <div style="height:50px;"></div>
  <div class="panel">
    <div class="panel panel-warning">
      <header class="panel-heading">
        <div class="fa fa-group"></div> Student Management
      </header>
    </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><span class="glyphicon glyphicon-plus-sign"></span> Add Student</h4>
          </div>
